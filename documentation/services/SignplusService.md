...
var input = new CreateEnvelopeRequest("name", EnvelopeLegalityLevel.Ses, 5, "comment", false);
...
var input = new ListEnvelopesRequest("name", tags, "comment", ids, statuses, folderIds, true, 0, 0, "uid", 7, 6, "after", "before", EnvelopeOrderField.CreationDate, false, true);
...
var text = new AnnotationText(0.7, 7.26, "value", "tooltip", "dynamic_field_name", font);
var font = new AnnotationFont(AnnotationFontFamily.Unknown, true, false);
var datetime = new AnnotationDateTime(7.51, font, "color", false, "timezone", 10, AnnotationDateTimeFormat.DmyNumericSlash);
var checkbox = new AnnotationCheckbox(true, AnnotationCheckboxStyle.CircleCheck);
var input = new AddAnnotationRequest("document_id", 7, 7.25, 7.35, 6.25, 9.77, AnnotationType.Text, "recipient_id", false, signature, initials, text, datetime, checkbox);
...
var tags = new List<string>() { "tags" };
var ids = new List<string>() { "ids" };
var input = new ListTemplatesRequest("name", tags, ids, 2, 0, "after", "before", TemplateOrderField.TemplateId, false);
