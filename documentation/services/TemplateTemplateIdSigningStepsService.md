...
var recipientsItem = new SigningStepsRecipients2(Optional<string?>.Of("string"), Optional<string?>.Of("string"), Optional<string?>.Of("string"), Optional<string?>.Of("string"), Optional<string?>.Of("RECEIVES_COPY"));
