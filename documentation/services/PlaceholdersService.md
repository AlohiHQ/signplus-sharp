...
var placeholdersItem = new SetEnvelopeAttachmentsPlaceholdersRequestPlaceholders(Optional<string?>.Of("string"), Optional<string?>.Of("string"), Optional<bool?>.Of(false), Optional<bool?>.Of(false), Optional<string?>.Of("string"), Optional<string?>.Of("string"));
