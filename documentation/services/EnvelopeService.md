...
var input = new CreateEnvelopeRequest(Optional<string?>.Of("PNeiZUQ9LB9"), Optional<string?>.Of("QES_ZERTES"), Optional<string?>.Of("<integer>"), Optional<string?>.Of("<string>"), Optional<bool?>.Of(false));
