...
var placeholdersItem = new SetTemplateAttachmentsPlaceholdersRequestPlaceholders(Optional<string?>.Of("<string>"), Optional<string?>.Of("<string>"), Optional<string?>.Of("<boolean>"), Optional<string?>.Of("<boolean>"), Optional<string?>.Of("<string>"), Optional<string?>.Of("<string>"));
