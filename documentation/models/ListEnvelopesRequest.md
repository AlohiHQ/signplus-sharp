...
| Statuses       | List<[EnvelopeStatus](EnvelopeStatus.md)>   | ❌       | List of envelope statuses                         |
...
| After          | string                                      | ❌       |                                                   |
| Before         | string                                      | ❌       |                                                   |
| OrderField     | [EnvelopeOrderField](EnvelopeOrderField.md) | ❌       | Field to order envelopes by                       |
