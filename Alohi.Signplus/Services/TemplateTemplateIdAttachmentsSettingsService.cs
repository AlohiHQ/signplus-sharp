...
/// <summary>
/// Service class providing access to API endpoints for TemplateTemplateIdAttachmentsSettingsService.
...
/// </summary>
public class TemplateTemplateIdAttachmentsSettingsService : BaseService
{
    private RequestConfig? _setTemplateAttachmentsSettingsAsyncConfig;

    internal TemplateTemplateIdAttachmentsSettingsService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public TemplateTemplateIdAttachmentsSettingsService SetSetTemplateAttachmentsSettingsAsyncConfig(
    ...
    public async Task<object> SetTemplateAttachmentsSettingsAsync(
        SetTemplateAttachmentsSettingsRequest? input,
        string templateId,
        string? accept,
    ...
    )
    {
        ...
        ;
        var validator = new SetTemplateAttachmentsSettingsRequestValidator();
