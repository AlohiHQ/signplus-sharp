...
/// <summary>
/// Service class providing access to API endpoints for EnvelopeEnvelopeIdAnnotationsDocumentIdService.
...
/// </summary>
public class EnvelopeEnvelopeIdAnnotationsDocumentIdService : BaseService
{
    private RequestConfig? _getEnvelopeDocumentAnnotationsAsyncConfig;

    internal EnvelopeEnvelopeIdAnnotationsDocumentIdService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public EnvelopeEnvelopeIdAnnotationsDocumentIdService SetGetEnvelopeDocumentAnnotationsAsyncConfig(
    ...
    public async Task<object> GetEnvelopeDocumentAnnotationsAsync(
        string envelopeId,
        string documentId,
        string? accept,
