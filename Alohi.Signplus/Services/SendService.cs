...
/// <summary>
/// Service class providing access to API endpoints for SendService.
...
public class SendService : BaseService
{
    ...
    internal SendService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public SendService SetSendEnvelopeAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> SendEnvelopeAsync(
        string envelopeId,
        string? accept,
