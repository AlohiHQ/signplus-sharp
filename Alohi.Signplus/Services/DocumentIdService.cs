...
/// <summary>
/// Service class providing access to API endpoints for DocumentIdService.
...
/// </summary>
public class DocumentIdService : BaseService
{
    private RequestConfig? _getEnvelopeDocumentAsyncConfig;

    internal DocumentIdService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public DocumentIdService SetGetEnvelopeDocumentAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> GetEnvelopeDocumentAsync(
        string envelopeId,
        string documentId,
        string? accept,
