...
/// <summary>
/// Service class providing access to API endpoints for WebhookService.
...
public class WebhookService : BaseService
{
    ...
    internal WebhookService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public WebhookService SetCreateWebhookAsyncConfig(RequestConfig config)
    {
