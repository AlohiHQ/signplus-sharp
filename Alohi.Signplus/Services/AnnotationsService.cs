...
/// <summary>
/// Service class providing access to API endpoints for AnnotationsService.
...
/// </summary>
public class AnnotationsService : BaseService
{
    private RequestConfig? _getEnvelopeAnnotationsAsyncConfig;

    internal AnnotationsService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public AnnotationsService SetGetEnvelopeAnnotationsAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> GetEnvelopeAnnotationsAsync(
        string envelopeId,
        string? accept,
