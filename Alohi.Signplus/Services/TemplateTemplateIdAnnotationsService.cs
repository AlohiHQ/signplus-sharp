...
/// <summary>
/// Service class providing access to API endpoints for TemplateTemplateIdAnnotationsService.
...
/// </summary>
public class TemplateTemplateIdAnnotationsService : BaseService
{
    private RequestConfig? _getTemplateAnnotationsAsyncConfig;

    internal TemplateTemplateIdAnnotationsService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public TemplateTemplateIdAnnotationsService SetGetTemplateAnnotationsAsyncConfig(
    ...
    public async Task<object> GetTemplateAnnotationsAsync(
        string templateId,
        string? accept,
