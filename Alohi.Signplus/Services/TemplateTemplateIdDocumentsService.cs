...
/// <summary>
/// Service class providing access to API endpoints for TemplateTemplateIdDocumentsService.
...
/// </summary>
public class TemplateTemplateIdDocumentsService : BaseService
{
    private RequestConfig? _getTemplateDocumentsAsyncConfig;

    internal TemplateTemplateIdDocumentsService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public TemplateTemplateIdDocumentsService SetGetTemplateDocumentsAsyncConfig(
    ...
    public async Task<object> GetTemplateDocumentsAsync(
        string templateId,
        string? accept,
