...
/// <summary>
/// Service class providing access to API endpoints for TemplateTemplateIdDocumentDocumentIdService.
...
/// </summary>
public class TemplateTemplateIdDocumentDocumentIdService : BaseService
{
    private RequestConfig? _getTemplateDocumentAsyncConfig;

    internal TemplateTemplateIdDocumentDocumentIdService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public TemplateTemplateIdDocumentDocumentIdService SetGetTemplateDocumentAsyncConfig(
    ...
    public async Task<object> GetTemplateDocumentAsync(
        string templateId,
        string documentId,
        string? accept,
