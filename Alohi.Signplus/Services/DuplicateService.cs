...
/// <summary>
/// Service class providing access to API endpoints for DuplicateService.
...
/// </summary>
public class DuplicateService : BaseService
{
    private RequestConfig? _duplicateEnvelopeAsyncConfig;

    internal DuplicateService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public DuplicateService SetDuplicateEnvelopeAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> DuplicateEnvelopeAsync(
        string envelopeId,
        string? accept,
