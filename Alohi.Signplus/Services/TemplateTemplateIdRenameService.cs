...
/// <summary>
/// Service class providing access to API endpoints for TemplateTemplateIdRenameService.
...
/// </summary>
public class TemplateTemplateIdRenameService : BaseService
{
    private RequestConfig? _renameTemplateAsyncConfig;

    internal TemplateTemplateIdRenameService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public TemplateTemplateIdRenameService SetRenameTemplateAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> RenameTemplateAsync(
