...
/// <summary>
/// Service class providing access to API endpoints for SigningStepsService.
...
/// </summary>
public class SigningStepsService : BaseService
{
    private RequestConfig? _addEnvelopeSigningStepsAsyncConfig;

    internal SigningStepsService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public SigningStepsService SetAddEnvelopeSigningStepsAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> AddEnvelopeSigningStepsAsync(
