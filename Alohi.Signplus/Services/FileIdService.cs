...
/// <summary>
/// Service class providing access to API endpoints for FileIdService.
...
/// </summary>
public class FileIdService : BaseService
{
    private RequestConfig? _getAttachmentFileAsyncConfig;

    internal FileIdService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public FileIdService SetGetAttachmentFileAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> GetAttachmentFileAsync(
        string envelopeId,
        string fileId,
        string? accept,
