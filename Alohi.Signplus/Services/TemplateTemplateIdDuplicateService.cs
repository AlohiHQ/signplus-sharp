...
/// <summary>
/// Service class providing access to API endpoints for TemplateTemplateIdDuplicateService.
...
/// </summary>
public class TemplateTemplateIdDuplicateService : BaseService
{
    private RequestConfig? _duplicateTemplateAsyncConfig;

    internal TemplateTemplateIdDuplicateService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public TemplateTemplateIdDuplicateService SetDuplicateTemplateAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> DuplicateTemplateAsync(
        string templateId,
        string? accept,
