...
/// <summary>
/// Service class providing access to API endpoints for DynamicFieldsService.
...
/// </summary>
public class DynamicFieldsService : BaseService
{
    private RequestConfig? _setEnvelopeDynamicFieldsAsyncConfig;

    internal DynamicFieldsService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public DynamicFieldsService SetSetEnvelopeDynamicFieldsAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> SetEnvelopeDynamicFieldsAsync(
