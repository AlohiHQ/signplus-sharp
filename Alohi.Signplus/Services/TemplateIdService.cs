...
/// <summary>
/// Service class providing access to API endpoints for TemplateIdService.
...
/// </summary>
public class TemplateIdService : BaseService
{
    private RequestConfig? _createEnvelopeFromTemplateAsyncConfig;

    internal TemplateIdService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public TemplateIdService SetCreateEnvelopeFromTemplateAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> CreateEnvelopeFromTemplateAsync(
