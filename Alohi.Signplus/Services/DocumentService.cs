...
/// <summary>
/// Service class providing access to API endpoints for DocumentService.
...
public class DocumentService : BaseService
{
    ...
    internal DocumentService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public DocumentService SetAddEnvelopeDocumentAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> AddEnvelopeDocumentAsync(
