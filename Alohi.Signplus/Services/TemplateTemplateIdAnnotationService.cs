...
/// <summary>
/// Service class providing access to API endpoints for TemplateTemplateIdAnnotationService.
...
/// </summary>
public class TemplateTemplateIdAnnotationService : BaseService
{
    private RequestConfig? _addTemplateAnnotationAsyncConfig;

    internal TemplateTemplateIdAnnotationService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public TemplateTemplateIdAnnotationService SetAddTemplateAnnotationAsyncConfig(
    ...
    public async Task<object> AddTemplateAnnotationAsync(
        AddTemplateAnnotationRequest? input,
        string templateId,
        string? accept,
    ...
    )
    {
        ...
        ;
        var validator = new AddTemplateAnnotationRequestValidator();
