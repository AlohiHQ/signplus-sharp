...
/// <summary>
/// Service class providing access to API endpoints for WebhooksService.
...
public class WebhooksService : BaseService
{
    ...
    internal WebhooksService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public WebhooksService SetListWebhooksAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> ListWebhooksAsync(
