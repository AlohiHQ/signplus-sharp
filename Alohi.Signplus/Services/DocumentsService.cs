...
/// <summary>
/// Service class providing access to API endpoints for DocumentsService.
...
public class DocumentsService : BaseService
{
    ...
    internal DocumentsService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public DocumentsService SetGetEnvelopeDocumentsAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> GetEnvelopeDocumentsAsync(
        string envelopeId,
        string? accept,
