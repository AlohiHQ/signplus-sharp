...
/// <summary>
/// Service class providing access to API endpoints for EnvelopeService.
...
public class EnvelopeService : BaseService
{
    ...
    internal EnvelopeService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public EnvelopeService SetCreateEnvelopeAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> CreateEnvelopeAsync(
