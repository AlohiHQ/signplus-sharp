...
/// <summary>
/// Service class providing access to API endpoints for TemplateTemplateIdAttachmentsPlaceholdersService.
...
/// </summary>
public class TemplateTemplateIdAttachmentsPlaceholdersService : BaseService
{
    private RequestConfig? _setTemplateAttachmentsPlaceholdersAsyncConfig;

    internal TemplateTemplateIdAttachmentsPlaceholdersService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public TemplateTemplateIdAttachmentsPlaceholdersService SetSetTemplateAttachmentsPlaceholdersAsyncConfig(
    ...
    public async Task<object> SetTemplateAttachmentsPlaceholdersAsync(
        SetTemplateAttachmentsPlaceholdersRequest? input,
        string templateId,
        string? accept,
    ...
    )
    {
        ...
        ;
        var validator = new SetTemplateAttachmentsPlaceholdersRequestValidator();
