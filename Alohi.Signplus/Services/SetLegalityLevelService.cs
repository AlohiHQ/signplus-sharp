...
/// <summary>
/// Service class providing access to API endpoints for SetLegalityLevelService.
...
/// </summary>
public class SetLegalityLevelService : BaseService
{
    private RequestConfig? _setEnvelopeLegalityLevelAsyncConfig;

    internal SetLegalityLevelService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public SetLegalityLevelService SetSetEnvelopeLegalityLevelAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> SetEnvelopeLegalityLevelAsync(
