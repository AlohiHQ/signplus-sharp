...
/// <summary>
/// Service class providing access to API endpoints for VoidService.
...
/// </summary>
public class VoidService : BaseService
{
    private RequestConfig? _voidEnvelopeAsyncConfig;

    internal VoidService(Client httpClient)
        : base(httpClient) { }
    ...
    /// </summary>
    public VoidService SetVoidEnvelopeAsyncConfig(RequestConfig config)
    {
    ...
    public async Task<object> VoidEnvelopeAsync(
        string envelopeId,
        string? accept,
